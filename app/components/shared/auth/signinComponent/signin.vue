    ...
    <section class="auth-panel">
      ...
      <div class="auth-panel__content">
        ...
        <form class="auth-panel__form">
          <UInput type="text" placeholder="Имя" />
          <UInput type="text" placeholder="Фамилия" />
          <UInput type="text" placeholder="Номер телефона" />
          <UInput type="text" placeholder="E-mail (Необязательно)" />
          <UInput type="password" placeholder="Пароль" />
          <UInput type="password" placeholder="Повторите пароль" />
          <Button>Продолжить</Button>
        </form>

        <p>
          Нет аккаунта?
          <NuxtLink to="/auth/login">Зарегистрируйтесь</NuxtLink>
        </p>
      </div>
    </section>
  </main>
